...
export const artworksData: Record<string, Artwork> = {
  ...
  "first-light": {
    ...
    year: "2025",
    price: "$2,600",
    image: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=580&h=480&fit=crop&crop=center",
    description: "Dawn breaking over a misty landscape with soft, diffused light.",
    longDescription:
      "The first light of day holds a special magic, transforming the familiar world into something ethereal and new. This painting captures that precious moment when darkness gives way to light, when the landscape emerges from shadow like a dream becoming reality. The soft, diffused light creates an atmosphere of hope and renewal.",
    technique: "Atmospheric oil painting with subtle color transitions",
    inspiration: "Early morning hikes and the magic of sunrise",
    dimensions: { width: 28, height: 36, depth: 1.5 },
    availability: "Available",
    exhibitions: ["Dawn Series 2025", "Light Studies Exhibition"],
    tags: ["dawn", "first light", "misty", "landscape", "atmospheric"],
    slug: "first-light",
  },
  "peaceful-waters": {
    id: 10,
